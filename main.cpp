...
//        status = worldCup->remove_team(i);
    ...
    int x25 = worldCup->get_closest_player(25,1).ans();
    int x3 = worldCup->get_closest_player(3,2).ans();
    int x4 = worldCup->get_closest_player(4,2).ans();
...
/*
    ...
    int x3 = worldCup->get_closest_player(3,2).ans();
    int x4 = worldCup->get_closest_player(4,2).ans();
    int x5 = worldCup->get_closest_player(5,1).ans();
    int x6 = worldCup->get_closest_player(6,2).ans();
    int x24 = worldCup->get_closest_player(24,2).ans();*/
