...
Player::Player(int playerId, int teamId, int gamesPlayed, int goals, int cards, bool goalKeeper, world_cup_t worldCup) : m_playerId(playerId), m_teamId(teamId), m_gamesPlayed(gamesPlayed), m_goals(goals),
